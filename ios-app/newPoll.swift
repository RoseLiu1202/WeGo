...
class NewPoll: UIView {
    ...
    private let questionLabel: UILabel = {
           let label = UILabel()
           label.text = "Based on what you guys have said: here are your current options"
...
class NewPollMessageCell: UITableViewCell {
    
    private let pollView = NewPoll()
