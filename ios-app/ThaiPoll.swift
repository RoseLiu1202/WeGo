...
//  WeGo
//
//  Created by Rose Liu on 10/26/25.
//
...
class ThaiPoll: UIView {
    
    // MARK: - Properties
    private let pollOptions = [
        "1️⃣ Thai Fusion",
        "2️⃣ Thai Country Cafe",
        "3️⃣ Top Thai"
    ]
    ...
    private let questionLabel: UILabel = {
           let label = UILabel()
           label.text = "Based on what you said… Here are 3 options near you:"
...
class ThaiPollMessageCell: UITableViewCell {
    
    private let pollView = ThaiPoll()
